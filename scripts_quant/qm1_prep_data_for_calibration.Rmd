...
```{r}
if(isFALSE(knitting)){
write_csv(mc.reads.samples,here('../','data','quant_modeling','QM_MOCKdata_input_samples_run.csv'))
}
```
...
```{r}
if(isFALSE(knitting)){
write_csv(sample.tax.thin,here('../','data','quant_modeling','QM_SAMPLEdata_taxonomy.csv'))
}
```
...
```{r}
if(isFALSE(knitting)){
write_csv(Obs_PCRcycles,here('../','data','quant_modeling','QM_SAMPLEdata_PCR.csv'))
}
```
